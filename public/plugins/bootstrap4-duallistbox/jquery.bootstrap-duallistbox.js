...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'Total : {0} Symbol ',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: 'Total : 0 Symbols ',                                                        // when there are no options present in the list

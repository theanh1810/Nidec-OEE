...
"use strict";
/*!******************************************!*\
  !*** ./resources/js/master-data/line.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
var route = "".concat(window.location.origin, "/api/settings/line");
var route_show = "".concat(window.location.origin, "/setting/setting-line/show");
var route_his = "".concat(window.location.origin, "/api/settings/line/history");
var route_return = "".concat(window.location.origin, "/setting/setting-line/return");
console.log(route);
var table = $('.table-line').DataTable(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
  scrollX: true,
  aaSorting: [],
  language: {
  ...
  ordering: false,
  searching: false
}, "dom", 'rt<"bottom"flp><"clear">'), "lengthMenu", [10, 15, 20, 25, 50]), "ajax", {
  url: route,
  dataSrc: 'data',

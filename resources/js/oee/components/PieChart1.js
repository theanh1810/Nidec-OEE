...
use([PieChart, GridComponent, LegendComponent, TooltipComponent, TitleComponent, CanvasRenderer])
...
const PieChart1 = ({ data }) => {
    ...
    useEffect(() => {
        ...
        chart.current.on('legendselectchanged', e => console.log(e))
    ...
    return (
        <div className={styles['pie-chart']}>
            <div className={styles['title']}>
                {t('Error stop and no-error stop rate chart')}
            </div>

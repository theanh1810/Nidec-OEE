...
/*!***************************************************!*\
  !*** ./resources/js/control_agv/control/point.js ***!
  \***************************************************/
...
var MyPoint = /*#__PURE__*/function () {
  function MyPoint(id, x, y, w, h, name, mapName, angle, offset, rev, area, partition, type, code) {
  ...
  _createClass(MyPoint, [{
    ...
    key: "caculateCor",
    value: function caculateCor(ratio, tox, toy) {
      push();
      this.cordX = (this.x - this.w / 2) * ratio + tox;
      this.cordY = (this.y - this.h / 2) * ratio + toy; // this.textX = (this.x - this.w/3)*ratio + tox;
    ...
    key: "createTiniPoint",
    value: function createTiniPoint(ratio, tox, toy) {
      push();
      fill(255);
      stroke(51);
    ...
    key: "drawLine",
    value: function drawLine(ratio, x01, y01, x02, y02) {
      push();
      fill(255);
      stroke(51);
      strokeWeight(1);
    ...
    key: "moveMousePoint",
    value: function moveMousePoint(ratio, tox, toy) {
    ...
    key: "clickedOldPoint",
    value: function clickedOldPoint(ratio) {
    ...
    key: "newPoint",
    value: function newPoint(ratio, tox, toy) {
    ...
    key: "setPoint",
    value: function setPoint(ratio, tox, toy) {
      // console.log('set');

$('.select2').select2()
import t from "../lang"
var route = `${window.location.origin}/api/settings/line`;
var route_show = `${window.location.origin}/setting/setting-line/show`;
var route_his = `${window.location.origin}/api/settings/line/history`;
var route_return = `${window.location.origin}/setting/setting-line/return`;
console.log(route);

const table = $('.table-line').DataTable({
    scrollX: true,
    aaSorting: [],
    language: {
